      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-darkGray rounded-xl p-8 border border-coolWhite/10">
          <div className="text-center">
            ...
            <h2 className="text-2xl font-semibold mb-4">Dark Web Monitoring</h2>
            <p className="text-gray-400 mb-6">
              Monitor the dark web for threats, leaked data, and intelligence relevant to your organization.
            </p>
