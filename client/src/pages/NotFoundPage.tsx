    ...
    <div className="min-h-screen bg-jetBlack flex flex-col items-center justify-center px-4">
      ...
      >
        ...
        <motion.div
          ...
          whileTap={{ scale: 0.95 }}
        >
          <Link to="/" className="inline-flex items-center justify-center px-6 py-3 bg-crimsonRed text-coolWhite rounded-lg font-medium transition-colors hover:bg-opacity-90 focus:outline-none focus:ring-2 focus:ring-crimsonRed focus:ring-offset-2 focus:ring-offset-darkGray">
