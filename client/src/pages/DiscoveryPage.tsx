              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-xs">Use exact email format (e.g., <code className="text-gray-300 bg-gray-800 px-1 py-0.5 rounded text-xs">user@example.com</code>) </p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-xs">Click Details to view credential info and breach context</p>
                  </div>
                </div>
              </motion.div>
            </div>
